...
public class UsuarioC extends HttpServlet{
    ...
    private void editar(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("usuarios", usuarios);
        req.getRequestDispatcher("usuario/editarus.jsp").forward(req, resp);
    }
    ...
    private void modificar(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        UsuarioDAO ud = new UsuarioDAO();
        model.Entity.Usuario u = new model.Entity.Usuario(nombre, id_usuario, genero, email, telefono, membresia, contrasenia);
        ud.actualizar(u);
        this.listarUsuarios(req, resp);
    }   
}
