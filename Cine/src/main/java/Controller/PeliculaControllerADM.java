 ...
 * @author USUARIO
 */
@WebServlet("/peliculaAMD")
public class PeliculaControllerADM extends HttpServlet {
    ...
    private void listarPeliculas(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("peliculasADM", peliculas);
        req.getRequestDispatcher("/PeliculaADM/VerPeliculas.jsp").forward(req, resp);
    }
    ...
    private void editar(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("peliculaADM", pelicula);
        req.getRequestDispatcher("PeliculaADM/EditarPelicula.jsp").forward(req, resp);
    }
